...
TEST(FitterTest, exepFitterBase) {
  auto shape = TrackFitterBase::TrackShape::arc;
...
TEST(FitterTest, ClusterFit) {
  ...
  auto fitter = std::make_unique<TrackFitCern>(TrackFitterBase::TrackShape::arc, false, 0, 1, func, nullptr, 0.027, true, nullptr, nullptr, 0);
