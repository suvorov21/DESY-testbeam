...
void SR_master() {
  ...
  list.push_back(std::vector<std::pair<TString, TString> > {std::make_pair("SR_z_360_275_200_02T.root", "200 ns 0.2 T"),
                                                          std::make_pair("SR_z_360_275_200_0T.root", "200 ns 0. T"),
                                                          std::make_pair("SR_z_360_275_412_02T.root", "412 ns 0.2 T"),
                                                          std::make_pair("SR_z_360_275_412_0T.root", "412 ns 0. T.")});

  list.push_back(std::vector<std::pair<TString, TString> > {std::make_pair("SR_g_200.root", "200 ns"),
                                                          std::make_pair("SR_g_412.root", "412 ns")});

  list.push_back(std::vector<std::pair<TString, TString> > {std::make_pair("SR_m_200.root", "200 ns"),
                                                          std::make_pair("SR_m_412.root", "412 ns")});

  list.push_back(std::vector<std::pair<TString, TString> > {std::make_pair("SR_p_430.root", "430 mm"),
                                                          std::make_pair("SR_p_530.root", "530 mm")});
