...
bool DBSCANReconstruction::FillOutput(const Int_t padAmpl[geom::nPadx][geom::nPady][geom::Nsamples], std::vector<Node> nodes, std::vector<DB_Cluster> clusters, TEvent* event){
